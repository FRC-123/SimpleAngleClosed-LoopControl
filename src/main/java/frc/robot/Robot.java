...
public class Robot extends TimedRobot {
  ...
  public double kP, kI, kD, kIz, kFF, kMaxOutput, kMinOutput,newsetp,rotations;
  ...
  public void robotInit() {
    ...
    SmartDashboard.putNumber("NewSet Position", 0);
  }
  ...
  public void teleopPeriodic() {
    ...
    double newsetp = SmartDashboard.getNumber("NewSet Position", 0);
    if ( rotations != newsetp ) {
      rotations = newsetp;
    }
